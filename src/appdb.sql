...
CREATE TABLE filters (
    ...
    car BOOL NOT NULL, -- 0 for false, 1 for true
    pet BOOL NOT NULL, -- 0 for false, 1 for true
    ...
    visible_phone BOOL, -- true means show phone, false means hide it
    visible_email BOOL, -- true means show email, false means hide it
